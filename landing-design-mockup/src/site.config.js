  ...
  addCarModal: {
    ...
    modelsByBrand: {
      ...
      opel: [
        ...
        { value: "opel-vectra-a", label: "Opel Vectra A" },
        { value: "opel-vectra-b", label: "Opel Vectra B" },
        ...
        { value: "opel-omega-b", label: "Opel Omega B" },
        { value: "opel-signum", label: "Opel Signum" },
        { value: "opel-calibra", label: "Opel Calibra" },
      ],
    },
    /**
    ...
    yearsByModel: {
      ...
      "opel-vectra-a": { from: 1988, to: 1995 },
      "opel-vectra-b": { from: 1995, to: 2002 },
      ...
      "opel-omega-b": { from: 1994, to: 2003 },
      "opel-signum": { from: 2003, to: 2008 },
      "opel-calibra": { from: 1989, to: 1997 },
    },
    cancelLabel: "Отмена",
    saveLabel: "Добавить",
  },
